const sections = [
  ...
  },
  {
    ...
    numeral: "贰",
    title: "结构与语言",
    description: "关注重复、称谓、物象与叙述节奏。共 6 题，每题 4 分。",
  },
  {
    id: "theme",
    numeral: "叁",
...
const questions = [
  ...
  },
  {
    ...
    prompt: "“我说好”在旅行与消费段落中多次出现，最主要的表达作用是什么？",
    options: ["制造快速、机械的顺从节奏", "展示叙述者善于提出计划", "表明所有要求都经过充分讨论", "暗示两人交流非常平等"],
    answer: [0],
    explanation: "短句反复压缩协商过程，让顺从呈现出自动响应般的节奏。",
  },
  {
    id: "q10", section: "craft", type: "single", points: 4,
    prompt: "空置楼层、清空影院和过大的私人空间反复出现，构成了怎样的结构？",
    options: ["投入越巨大，中心人物越缺席", "地点越遥远，人物越快乐", "空间越空，劳动越少", "消费越多，误会越容易解除"],
    answer: [0],
    explanation: "财富制造了空场与隐私，也持续放大孤独、缺席和关系中的回声。",
  },
  {
    id: "q11", section: "craft", type: "single", points: 4,
    prompt: "清洁工、贴胶带的女孩、机组与看房助理被反复写入，主要有何作用？",
    options: ["增加旅行攻略信息", "让奢华生活背后的劳动和代价显形", "证明配角比主角富有", "说明所有服务都由同一团队完成"],
    answer: [1],
    explanation: "具体劳动把抽象财富变成时间、体力和技术，也照出核心人物对这些成本的不同感知。",
  },
  {
    id: "q12", section: "craft", type: "single", points: 4,
    prompt: "那张 2007 年 QQ 图片被不断转移到新设备，最适合怎样理解？",
    options: ["它保存了清晰可靠的现实证据", "它承载长期等待、投射与自我神话", "它用于证明好友申请已经通过", "它记录了两人第一次共同旅行"],
    answer: [1],
    explanation: "图片始终模糊，却被十九年保存；叙述者持续把欲望和成长故事投射其上。",
  },
  {
    id: "q13", section: "craft", type: "single", points: 4,
    prompt: "关键电话末尾，称谓从“妈妈”重新变为“景甜”，这一变化意味着什么？",
    options: ["地点发生变化", "家庭角色停止运作，叙述距离骤然拉开", "叙述者记错了名字", "女方要求恢复全名"],
    answer: [1],
    explanation: "称谓承担关系角色。回到名字，标志亲密仪式终止，也让关系破裂变得可见。",
  },
  {
    id: "q14", section: "craft", type: "single", points: 4,
    prompt: "“什么都没有发生”在文中多次回返，最准确的分析是？",
    options: ["取消此前全部情节", "把宏大投入、热闹场面与最终空缺串联起来", "说明叙述者已经失忆", "单纯用于切换年份"],
    answer: [1],
    explanation: "它是结构性的回声，把电影、空间、关系和结尾共同纳入“巨大动静之后留下空缺”的模式。",
  },
  {
  ...
  },
  {
    ...
    prompt: "下列哪些细节体现了奢华场景背后的具体劳动？（多选）",
    options: ["清洁工每天整理无人居住的整层房间", "两个女孩摸索出早晨贴胶带更牢", "助理逐套拍摄香港房产", "机组为配平加油并在抵达后放掉", "QQ 图片在设备上越来越清晰"],
    answer: [0, 1, 2, 3],
    explanation: "前四项都把资源调度落到具体劳动上；QQ 图片始终模糊，且不属于劳动链条。",
  },
  {
